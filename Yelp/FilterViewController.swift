...
class FilterViewController: UIViewController, UITableViewDataSource, UITableViewDelegate, SwitchCellDelegate {
    ...
    var sortingTypes: [[String:String]]!
    ...
    @IBAction func onSearchButton(sender: AnyObject) {
        ...
        for (row, isSelected) in switchStates {
            if isSelected {
                selectedCategories.append(categoryList[row]["code"]!)
            }
        }
    ...
    func loadOptions() {
        ...
        sortingTypes = self.getSortingTypes()
        distances = self.getDistances()
        sections["categoryList"] = categoryList
        sections["distanceList"] =  distances
        sections["sortingTypeList"] = sortingTypes
    }
    ...
    func tableView(tableView: UITableView, numberOfRowsInSection section: Int) -> Int{
        ...
        case 0:
            return 1
        case 1:
            let distanceOptions = sections["distanceList"] as! [Double]
            return distanceOptions.count
        case 2:
            let sortOptions = sections["sortingTypeList"] as! [[String:String]]
            return sortOptions.count
        case 3:
            let categoryOptions = sections["categoryList"] as! [[String:String]]
            ...
            if let cell = tableView.cellForRowAtIndexPath(indexPath) {
                if cell.accessoryType == .Checkmark {
                    ...
                    if(selectedSection == 1) {
                        ...
                        selectedFilters["sortingType"] = nil
                    }
                }
                else {
                    cell.accessoryType = .Checkmark
                    if(selectedSection == 1) {
                        selectedFilters["distance"] = distances[selectedRow]
                    } else if(selectedSection == 2) {
                        selectedFilters["sortingType"] = sortingTypes[selectedRow]["code"]
                    }
                
                    //reset other rows of that section
                    for row in 0...self.tableView.numberOfRowsInSection(selectedSection)-1{
                        if(row == selectedRow) {
                            continue
                        }
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            switchCell.switchLabel.text = "Deal"
            switchCell.delegate = self
            switchCell.onSwitch.on = deals
            switchCell.accessoryType = UITableViewCellAccessoryType.None
            return switchCell
        case 1:
            let checkboxCell = tableView.dequeueReusableCellWithIdentifier("CheckboxCell", forIndexPath: indexPath) as! CheckboxCell
            checkboxCell.nameLabel.text = String(distances[indexPath.row]) + " miles"
            return checkboxCell
        case 2:
            let checkboxCell = tableView.dequeueReusableCellWithIdentifier("CheckboxCell", forIndexPath: indexPath) as! CheckboxCell
            
            checkboxCell.nameLabel.text = sortingTypes[indexPath.row]["name"]
            return checkboxCell
            
        case 3:
            let switchCell = tableView.dequeueReusableCellWithIdentifier("SwitchCell", forIndexPath: indexPath) as! SwitchCell
            switchCell.switchLabel.text = categoryList[indexPath.row]["name"]
            switchCell.delegate = self
    ...
    func getSortingTypes() -> [[String:String]] {
